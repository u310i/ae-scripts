...
createAt1CompButton.text = "@コンポ";var times = function times(step, callback) {
...
var createAtComp = function createAtComp(folder) {
  ...
  targetItems.forEach(function (comp) {
    ...
    newComp.comment = commentArray[0].toUpperCase() + commentArray.slice(1).join("_");
    var layer = newComp.layers.add(comp);
...
var main = function main() {
  ...
  searchInputText.text = "work_*_*_*";
  replaceInputText.text = "E504_BAR狙え_$1_$2_$3"; // main

  var folders = setFolder();
  ...
  marginFolder = folders.margin; // setFolderButton
